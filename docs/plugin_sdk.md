...
- `cogedu/cta/cognitive_twin.py`: CognitiveTwinAgent + HumanFeedbackEntry 实现
- `cogedu/runtime/api.py`: 6 plan API (含 plan_human_feedback_aware)
- `cogedu/lca/orchestrator.py`: LCAEngine._cognitive_twin + append_human_feedback

...
- [cogedu/plugins/base.py](../cogedu/plugins/base.py) — Plugin ABC + PluginMetadata
- [cogedu/plugins/registry.py](../cogedu/plugins/registry.py) — PluginRegistry singleton
- [cogedu/plugins/first_party/](../cogedu/plugins/first_party/) — 3 first-party plugin
- [cogedu/persistence/plugin_registry_store.py](../cogedu/persistence/plugin_registry_store.py) — Plugin metadata 持久化

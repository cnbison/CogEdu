...
if TYPE_CHECKING:
    from cogedu.lca.l4_optimization.pomdp_solver import PBVI
...
class POMDPPolicy:
    ...
    def _init_pbvi_solver(self) -> "PBVI":
        ...
        if self.solver is None:
            from cogedu.lca.l4_optimization.pomdp_solver import (
                PBVI,
    ...
    def _update_t_r(self, arm: int, observation: int, reward: float) -> None:
        ...
        from cogedu.lca.l4_optimization.pomdp_learner import (
            RewardPosterior,
            TransitionPosterior,
        )
    ...
    def load_state(self, state: Dict[str, Any]) -> None:
        ...
        if solver_state is not None:
            ...
            restored_alphas = []
            from cogedu.lca.l4_optimization.pomdp_solver import AlphaVector
        ...
        from cogedu.lca.l4_optimization.pomdp_diagnostic import POMDPDiagnostic
        self._evolution = []

...
from cogedu.plugins.base import Plugin
...
class PluginRegistry:
    ...
    def load_from_db(self, store: Any) -> List[str]:
        ...
        """
        from cogedu.plugins.base import PluginMetadata
...
def _instantiate_first_party_plugin(name: str) -> Optional[Any]:
    ...
    try:
        ...
        if name == "parent_engagement":
            from cogedu.plugins.first_party import ParentEngagementPlugin
            return ParentEngagementPlugin()
        if name == "teacher_progress":
            from cogedu.plugins.first_party import TeacherProgressPlugin

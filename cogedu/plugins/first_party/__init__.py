...
用法:
    >>> from cogedu.plugins.registry import PluginRegistry
...
from cogedu.plugins.first_party.hint_fatigue import HINT_FATIGUE_THRESHOLD, HintFatiguePlugin
from cogedu.plugins.first_party.parent_engagement import ParentEngagementPlugin

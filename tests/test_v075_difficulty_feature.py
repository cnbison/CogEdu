...
from cogedu.lca.l4_optimization.linucb import LinUCB, BanditConfig
...
class TestLinUCBScoreArm:
    ...
    def test_score_arm_out_of_range_returns_zero(self, caplog):
        ...
        bandit = LinUCB(n_arms=3, context_dim=4, alpha=1.0)
        with caplog.at_level(logging.WARNING, logger="cogedu.lca.l4_optimization.linucb"):
...
class TestV075Lbc003DifficultyImprovement:
    ...
    def test_arm_features_changes_v3_distribution(self, lbc_history):
        ...
        from cogedu.lca.orchestrator import LCAEngineConfig

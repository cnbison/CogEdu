...
def cta_input(belief_state):
    ...
    from cogedu.lca.orchestrator import CTAInput
...
class TestPlannerConstruction:
    ...
    def test_planner_default_construction(self):
        ...
        from cogedu.lca.planner import Planner
    ...
    def test_planner_custom_config(self):
        ...
        from cogedu.lca.planner import Planner, PlannerConfig
    ...
    def test_planner_config_default_values(self):
        ...
        from cogedu.lca.planner import PlannerConfig
...
class TestPlannerPlan:
    ...
    def test_plan_returns_plan_decision(self, cta_input):
        ...
        from cogedu.lca.planner import Planner, PlanDecision
    ...
    def test_plan_with_intervention_history(self, cta_input, belief_state):
        ...
        from cogedu.lca.orchestrator import CTAInput
        from cogedu.lca.planner import Planner
        from cogedu.lca.intervention import Intervention, InterventionType, CLTLevel, CAStage
        from cogedu.cta.belief_state import BloomLevel
    ...
    def test_plan_without_intervention_history(self, cta_input):
        ...
        from cogedu.lca.planner import Planner
        from cogedu.lca.intervention import CAStage
...
class TestLCAEnginePlannerIntegration:
    ...
    def test_lca_engine_select_delegates_to_planner(self, belief_state):
        ...
        from cogedu.lca.orchestrator import CTAInput, LCAResult
...
class TestPlannerBackwardCompat:
    ...
    def test_engine_clt_via_getattr(self):
        ...
        engine = LCAEngine()
        clt = engine.clt
        from cogedu.lca.l3_selection import AdaptiveCLTPresender
    ...
    def test_engine_bjork_components_via_getattr(self):
        ...
        from cogedu.lca import LCAEngine
        from cogedu.lca.l3_selection import (
            BjorkTestingEffect, BjorkSpacingEffect, CAScaffoldingDecay,
        )
        from cogedu.lca.l4_optimization import CAStateMachine
...
class TestPlannerDefensiveChecks:
    ...
    def test_no_silent_pass_in_planner(self):
        ...
        import inspect
        from cogedu.lca import planner as planner_mod

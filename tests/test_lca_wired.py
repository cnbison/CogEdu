...
防御性自检 [2]: __version__ 同步 (cogedu/__init__.py 0.56.0)
"""
...
def fresh_lca_state(monkeypatch):
    ...
    from cogedu.persistence.lca_store import get_lca_store
...
class TestDefensiveChecks:
    ...
    def test_version_bump(self):
        ...
        base = cogedu.__version__.split("-")[0]
        current = Version(base)
        assert current >= Version("0.56.0"), \
            f"cogedu.__version__ 应 >= 0.56.0 (v0.56.0 LCA 接入), 实际={cogedu.__version__}"

...
@pytest.fixture
def learner():
    from cogedu.lca.l4_optimization.policy_learner import LCAPolicyLearner, BanditConfig
...
class TestStrategyChallengeUsesApplyPenalty:
    ...
    def test_lca_revise_policy_calls_apply_penalty(self, learner, belief_state):
        ...
        from cogedu.dual_agent.modes.strategy_challenge import StrategyChallengeMode
        from cogedu.dual_agent.protocol.messages import StrategyChallenge
        from cogedu.lca.intervention import (
            Intervention, InterventionType, CAStage, CLTLevel, BloomLevel,
        )
        from cogedu.lca.orchestrator import LCAEngine, LCAEngineConfig, CTAInput
...
class TestLbc003ReplayPenaltyBounded:
    ...
    def test_penalty_bounded_after_replay(self, lbc_history):
        ...
        import json
        from cogedu.dual_agent.orchestrator import DualAgentConfig, DualAgentOrchestrator
        from cogedu.cta.belief_engine import Observation

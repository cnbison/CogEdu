...
class TestPlattScalerBasic:
    ...
    def test_identity_when_unfitted(self):
        ...
        from cogedu.dual_agent.calibration import PlattScaler
        scaler = PlattScaler()
    ...
    def test_fit_with_scipy_failure_keeps_identity(self, monkeypatch, caplog):
        ...
        from cogedu.dual_agent import calibration as calib_mod
        from cogedu.dual_agent.calibration import PlattScaler
...
class TestStudentCalibrationTracker:
    ...
    def test_cold_start_returns_raw(self):
        ...
        from cogedu.dual_agent.calibration import StudentCalibrationTracker
...
class TestIsotonicCalibrator:
    ...
    def test_identity_when_unfitted(self):
        ...
        from cogedu.dual_agent.calibration import IsotonicCalibrator

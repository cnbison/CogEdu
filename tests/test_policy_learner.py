...
class TestPolicyLearnerConstruction:
    ...
    def test_default_construction(self):
        ...
        from cogedu.lca.policy_learner import PolicyLearner, PolicyLearnerConfig
    ...
    def test_per_student_lazy_init(self):
        ...
        from cogedu.lca.policy_learner import PolicyLearner
...
class TestPolicyLearnerColdStart:
    ...
    def test_failure_returns_true(self, caplog):
        ...
        try:
            ...
            with caplog.at_level(logging.WARNING, logger="cogedu.lca.policy_learner"):
...
class TestLCAEnginePolicyLearnerIntegration:
    ...
    def test_lca_engine_update_delegates_to_policy_learner(self, belief_state):
        ...
        from cogedu.lca import LCAEngine
        from cogedu.lca.cta_input import CTAInput
        from cogedu.lca.intervention import Intervention, InterventionType, CAStage, CLTLevel
        from cogedu.cta.belief_state import BloomLevel
    ...
    def test_lca_engine_config_propagates_cold_start_threshold(self):
        ...
        from cogedu.lca.l4_optimization import BanditConfig

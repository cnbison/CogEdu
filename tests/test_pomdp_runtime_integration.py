...
from cogedu.lca.l4_optimization import POMDPPolicy
from cogedu.lca.l4_optimization.policy_learner import LCAPolicyLearner
from cogedu.lca.l4_optimization.pomdp import SCHEMA_VERSION
...
def test_policy_ab_test_create_fresh_bandit_pomdp_uses_action_dependent_transition():
    ...
    验证:
      ...
      - 不同 action → 不同 T[a]
    """
    from cogedu.evaluation.policy_ab_test import PolicyABTest

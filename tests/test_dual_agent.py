...
from cogedu.cta.belief_engine import BeliefEngine, Observation
from cogedu.cta.belief_state import BloomLevel
from cogedu.dual_agent import (
    DualAgentConfig,
    DualAgentOrchestrator,
)
from cogedu.dual_agent.anti_hallucination import (
    BeliefDistributionCheck,
    ExperimentDesignValidator,
    HumanReviewConfig,
    HumanReviewTrigger,
)
from cogedu.dual_agent.deadlock import SingleAgentFallback, TimeoutGuard
from cogedu.dual_agent.modes import (
    DETECT_WINDOW,
...
from cogedu.dual_agent.modes.belief_challenge import BLOOM_JUMP_THRESHOLD
from cogedu.dual_agent.protocol import (
    BeliefChallenge,
    CalibratedLCAResult,
    CalibrationMessage,
    CalibrationState,
...
from cogedu.dual_agent.protocol.state_machine import _TRANSITIONS
...
def lca_engine(cta_engine):
    ...
    from cogedu.lca.orchestrator import LCAEngine
    return LCAEngine()
...
class TestCalibratedLCAResult:
    def _make_lca_result(self, cta_engine, intervention_type=InterventionType.PRACTICE):
        from cogedu.lca.orchestrator import LCAResult
        i = Intervention(

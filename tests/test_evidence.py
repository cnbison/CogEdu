...
def in_memory_db():
    ...
    import sqlite3
    from cogedu.persistence.db import SCHEMA_SQL
...
def evidence_engine(in_memory_db):
    ...
    from cogedu.evidence import EvidenceEngine, EvidenceConfig
...
class TestEvidenceSchema:
    ...
    def test_evidence_source_enum_has_6_values(self):
        ...
        from cogedu.evidence import EvidenceSource
...
class TestEvidenceEngineBehavior:
    ...
    def test_auto_prune_warning_logged(self, in_memory_db, caplog):
        ...
        import logging
        from cogedu.persistence.db import Database
        from cogedu.evidence import EvidenceEngine, EvidenceConfig, Evidence, EvidenceSource
        ...
        with caplog.at_level(logging.WARNING, logger="cogedu.evidence.evidence_engine"):
            for i in range(3):
                engine.add(Evidence(
                    source=EvidenceSource.RESPONSE_HISTORY, student_id="s1",
                    timestamp=datetime.now(), payload={"correct": True},
...
class TestEvidenceDefensiveChecks:
    ...
    def test_no_silent_pass_in_evidence(self):
        ...
        import inspect
        from cogedu.evidence import evidence as evidence_mod
        from cogedu.evidence import evidence_engine as engine_mod

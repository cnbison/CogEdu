...
class TestBeliefStateAddEvidence:
    ...
    def test_add_evidence_to_tc(self, belief_state):
        ...
        from cogedu.cta.belief_state import TCState
...
class TestBeliefUpdatorEvidenceIntegration:
    ...
    def test_belief_updater_without_evidence_engine_uses_legacy_path(self, belief_state):
        ...
        from cogedu.cta.belief_updater import BeliefUpdator
        from cogedu.cta.state_engine import get_default_engine

        updater = BeliefUpdator(state_engine=get_default_engine())
        assert updater.evidence_engine is None

        # 模拟 dim updates
        from cogedu.cta.inference_engine import InferenceResult
...
class TestV098EvidenceWiring:
    ...
    def test_add_gate_disabled_no_scan(self):
        ...
        from cogedu.evidence import Evidence, EvidenceSource
        from cogedu.evidence.evidence_engine import EvidenceConfig, EvidenceEngine
        from cogedu.persistence.db import Database, SCHEMA_SQL

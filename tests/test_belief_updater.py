...
from cogedu.cta.belief_state import (
    BeliefState,
    BloomLevel,
...
from cogedu.cta.inference_engine import InferenceEngine, InferenceResult, ObservationContext
from cogedu.cta.state_engine import StateEngine, get_default_engine
...
def test_integration_inference_then_apply_matches_v079_mutation_shape():
    ...
    """
    from cogedu.cta.l1_evolution import BKTEvolutionLayer
    from cogedu.cta.l2_mirt import BiFactorMIRT5D
    ...
    tc_detector = __import__("cogedu.cta.tc_detector", fromlist=["TCStateDetector"]).TCStateDetector()

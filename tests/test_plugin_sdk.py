...
class TestH3C4Canary:
    ...
    def test_lca_path_unaffected(self):
        ...
        # 防御性: 允许 from cogedu.lca.cta_input (data class), 但不应 import orchestrator 等核心
        forbidden_imports = [
            "from cogedu.lca.orchestrator",
            "from cogedu.lca.l4_optimization",
            "from cogedu.lca.intervention",
        ]

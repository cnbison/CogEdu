...
def belief_state():
    ...
    from cogedu.cta.belief_engine import BeliefEngine, BeliefEngineConfig
    from cogedu.cta.l1_evolution import EvolutionConfig
    from cogedu.cta.l2_mirt import MIRTConfig
...
def cta_input(belief_state):
    ...
    from cogedu.lca.cta_input import CTAInput
...
def plan_decision_default(belief_state):
    ...
    from cogedu.lca.planner import PlanDecision
    from cogedu.lca.intervention import CAStage, CLTLevel
    from cogedu.cta.belief_state import BloomLevel
...
class TestExperimentDesignerConstruction:
    ...
    def test_designer_default_construction(self):
        ...
        from cogedu.lca.experiment_designer import (
    ...
    def test_designer_custom_config(self):
        ...
        from cogedu.lca.experiment_designer import ExperimentDesigner, ExperimentDesignerConfig
        from cogedu.lca.intervention import InterventionType
    ...
    def test_design_produces_n_candidates(self, plan_decision_default, cta_input):
        ...
        from cogedu.lca.experiment_designer import ExperimentDesigner
        from cogedu.lca.intervention import Intervention
...
class TestExperimentDesignerCAStage:
    ...
    def test_modeling_stage_uses_explanatory(self, plan_decision_default, cta_input):
        ...
        from cogedu.lca.experiment_designer import ExperimentDesigner
        from cogedu.lca.intervention import InterventionType, CAStage
...
class TestExperimentDesignerBjorkAndCLT:
    ...
    def test_bjork_test_adds_retrieval(self, plan_decision_default, cta_input):
        ...
        from cogedu.lca.experiment_designer import ExperimentDesigner
        from cogedu.lca.intervention import InterventionType, CAStage, CLTLevel
        from cogedu.cta.belief_state import BloomLevel
        from cogedu.lca.planner import PlanDecision
        ...
        from cogedu.lca.experiment_designer import ExperimentDesignerConfig
        ...
        #   所以 INQUIRY 保留
        from cogedu.lca.intervention import CAStage as CAS
        plan2 = PlanDecision(
            bloom_target=BloomLevel.APPLY,
...
class TestLCAEngineDesignerIntegration:
    ...
    def test_lca_engine_constructs_with_default_designer(self):
        ...
        from cogedu.lca import LCAEngine, ExperimentDesignerConfig
    ...
    def test_lca_engine_select_delegates_to_designer(self, belief_state):
        """LCAEngine.select_intervention step 5 委托 self.experiment_designer.design()."""
        from cogedu.lca import LCAEngine
        from cogedu.lca.cta_input import CTAInput
    ...
    def test_lca_engine_designer_config_field(self):
        ...
        from cogedu.lca import LCAEngine, LCAEngineConfig
        from cogedu.lca.experiment_designer import ExperimentDesignerConfig
        from cogedu.lca.intervention import InterventionType
...
class TestExperimentDesignerDefensiveChecks:
    ...
    def test_no_silent_pass_in_designer(self):
        ...
        import inspect
        from cogedu.lca import experiment_designer as designer_mod

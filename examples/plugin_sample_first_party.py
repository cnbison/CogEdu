...
from cogedu.event.bus import EventBus
from cogedu.persistence.plugin_registry_store import PluginRegistryStore
from cogedu.plugins.first_party import (
    HintFatiguePlugin,
    ParentEngagementPlugin,
    TeacherProgressPlugin,
)
from cogedu.plugins.registry import (
    PluginRegistry,
...
def _self_test_imports() -> bool:
    ...
    """
    try:
        from cogedu.plugins.first_party import (  # noqa: F401
            HintFatiguePlugin,
            ParentEngagementPlugin,
            TeacherProgressPlugin,
        )
        from cogedu.plugins.registry import PluginRegistry, get_default_registry  # noqa: F401
        from cogedu.persistence.plugin_registry_store import PluginRegistryStore  # noqa: F401
        from cogedu.cta.event_log import LearningEvent  # noqa: F401
        from cogedu.event.bus import EventBus  # noqa: F401
        return True

...
from cogedu.cta.cognitive_twin import (
    CognitiveTwinAgent,
    HUMAN_FEEDBACK_EVENT_TYPES,
    HumanFeedbackEntry,
)
from cogedu.cta.event_log import LearningEvent, LearningEventType
from cogedu.event import EventBus, get_default_bus
# v0.94.0-c: 第一方 plugin SDK (HintFatiguePlugin 替代内联 hint_fatigue handler)
from cogedu.plugins.first_party import HintFatiguePlugin
...
def use_case_hint_fatigue_detection(bus: EventBus, lca_engine: Any) -> Optional[str]:
    ...
    from cogedu.plugins.registry import get_default_registry, PluginRegistry
...
def _self_test_imports() -> bool:
    ...
    """
    try:
        from cogedu.cta.cognitive_twin import CognitiveTwinAgent  # noqa: F401
        from cogedu.cta.event_log import LearningEvent, LearningEventType  # noqa: F401
        from cogedu.event import EventBus  # noqa: F401
        return True
